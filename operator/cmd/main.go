...
import (
	...
	"github.com/cloudscript-technology/dumpscript/operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(dumpscriptv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f01f83c8.cloudscript.com.br",
	...
	if err := (&controller.BackupScheduleReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("backupschedule-controller"),
