...
> Documentação detalhada: [**kind-e2e.md**](./kind-e2e.md) — lista completa
> dos ~60+ specs (postgres + mysql + mariadb + mongodb + redis + etcd × S3 +
> GCS + Azure), diagrama do ambiente, helpers, troubleshooting e CI.
